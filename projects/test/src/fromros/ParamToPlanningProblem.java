...
public class ParamToPlanningProblem {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
        InputStream input = new FileInputStream("/home/bhuvanesh/tiago_public_ws/src/tiago_simulation/mult_protap_sim/params/ros_param_to_json.json");
        String jsonString = IOUtils.toString(input,"utf8");
